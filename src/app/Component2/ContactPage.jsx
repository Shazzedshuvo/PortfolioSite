...
const ContactPage = () => {
  ...
  const leftX = useTransform(mouseX, [0, windowSize.width || 1], [-20, 20]);
  const leftY = useTransform(mouseY, [0, windowSize.height || 1], [-10, 10]);
  const rightX = useTransform(mouseX, [0, windowSize.width || 1], [20, -20]);
  const rightY = useTransform(mouseY, [0, windowSize.height || 1], [-10, 10]);
        ...
        >
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <ul className="text-gray-400 text-sm mt-1 space-y-1">
                <li>shazzedshuvo@gmail.com</li>
                <li>shazzed2003@gmail.com</li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mt-1">
                Tetulia, Panchagarh, Bangladesh, 5030
              </p>
            </div>
          </div>
        </motion.div>
